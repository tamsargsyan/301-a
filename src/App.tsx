...
function App() {
  const sections = [
    ...
    },
    {
      ...
      h2: "",
      p: "Мы разработали четыре основные гипотезы, согласно которым Армения может развиваться и позиционировать себя на карте планеты.",
      btn: undefined,
      icon: ICON_3,
      pattern1: undefined,
      pattern2: undefined,
